...
folder_path_new = r'C:\Users\vjanc\OneDrive\Documents\UniversityofOttawa\SUNLAB2023\Summer\CWEEDS_DHI_Percent_All_Years'
province_abv = 'NB'
date_format = '%Y%m%d%H'
...
for file in tqdm(csv_files, desc="Processing files", unit="file"):
    try:
        ...
        df['DHI%'] = df['Diffuse horizontal irradiance / kJ/m2'] / df['Global horizontal irradiance / kJ/m2'] * 100
...
new_file_all_years = os.path.join(folder_path_new, f'CWEEDS_All_Years_{province_abv}_DHI_percent.csv')
